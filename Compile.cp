...
/*short GetRelativeRate(Handle sound)
{
	...
	//DŽcale le sample
	if(globalOffset < (patternLength / 2)) { //AccŽlŽrer
		do {
			++times;
...
short Compile_Music()
{
	...
	//CREE FICHIER
	if(theReply.sfReplacing) { //Efface le fichier si existe dŽjˆ
	...
	//Ecrit le numŽro de version de l'enregistrement
	bytesNumber = 2;
