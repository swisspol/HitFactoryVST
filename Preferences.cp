...
short Read_Pref()
{
	...
	if(temp != prefVersion) { //Contr™le le numŽro de version
	...
	bytesNumber = sizeof(thePrefs); //charge la structure en mŽmoire
...
void Dispose_PrefDialog()
{
	...
	//Examine le nombre de voix du synthŽtiseur
	...
	//Examine le nombre de voix de la Bo”te ˆ Rythmes:
