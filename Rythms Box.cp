...
short RB_SavePatternSet()
{
	...
	theError = FSpCreate(&theReply.sfFile, 'HiFc', 'Patt', theReply.sfScript); //Crée le fichier
	if(theError) {
...
short RB_WritePatternSet(short fileID)
{
	...
	//écrit le numéro de version du set
	bytesNumber = 2;
	...
	//écrit le numéro de version des préférences
	bytesNumber = 2;
	...
	//Ecrit les références des fichiers sons de la boîte à rythmes
	bytesNumber = 4;
...
short RB_ReadPatternSet(short fileID)
{
	...
	//Contrôle le numéro de version du set
	bytesNumber = 2;
	...
	//Contrôle le numéro de version des préférences
	bytesNumber = 2;
	FSRead(fileID, &bytesNumber, &tempID);
	...
	bytesNumber = 4;
	//Charge les fichiers sons de la boîte à rythmes
	for(i = 0; i < kPatternParts; ++i) {
